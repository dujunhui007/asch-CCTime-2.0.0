const lang = {
  ...
  NEW_PWD_TIP_2:
    'Make sure you have saved your master secret in a safe place. If you lost it or forget it, your account will not be available and you will lost all your XAS.',
  CONFIRM: 'Confirm',
  CANCEL: 'Cancel',
  ...
  ERR_ASSET_PRECISION_MUST_BE_INTEGER_BETWEEN_0_16:
    'The asset precision must be an integer between 0 and 16',
  ...
  table: {
    ...
    loading: 'Loading...',
    selectedRows: rows =>
      rows > 0 ? `${rows} row${rows === 1 ? '' : 's'} selected.` : 'No selected rows.',
